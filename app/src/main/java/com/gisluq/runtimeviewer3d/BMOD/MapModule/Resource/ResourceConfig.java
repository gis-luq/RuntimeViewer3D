package com.gisluq.runtimeviewer3d.BMOD.MapModule.Resource;
...
public class ResourceConfig {
    ...
    /**资源列表**/
    public SceneView sceneView = null;//地图控件
    ...
    private void initConfig() {
        this.sceneView = (SceneView) activiy.findViewById(R.id.activity_map_sceneview);
