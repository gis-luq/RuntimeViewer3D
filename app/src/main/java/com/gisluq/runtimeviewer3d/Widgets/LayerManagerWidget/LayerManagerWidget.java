package com.gisluq.runtimeviewer3d.Widgets.LayerManagerWidget;
...
import com.gisluq.runtimeviewer3d.BMOD.MapModule.BaseWidget.BaseWidget;
import com.gisluq.runtimeviewer3d.R;
import com.gisluq.runtimeviewer3d.Utils.FileUtils;
import com.gisluq.runtimeviewer3d.Widgets.LayerManagerWidget.Adapter.LayerListviewAdapter;
import com.gisluq.runtimeviewer3d.Widgets.LayerManagerWidget.Adapter.LegendListviewAdapter;
import com.gisluq.runtimeviewer3d.Widgets.LayerManagerWidget.BaseMap.BaseMapManager;
import com.gisluq.runtimeviewer3d.Widgets.LayerManagerWidget.BaseMap.BasemapLayerInfo;
...
//        super.showMessageBox(super.name);
    ...
    private void initWidgetView() {
        ...
        legendListviewAdapter = new LegendListviewAdapter(context,super.sceneView.getScene().getOperationalLayers());
        ...
        basemapLayerListviewAdapter = new LayerListviewAdapter(context,super.sceneView.getScene().getBasemap().getBaseLayers());
        this.baseMapLayerListView.setAdapter(basemapLayerListviewAdapter);
        featureLayerListviewAdapter = new LayerListviewAdapter(context,super.sceneView.getScene().getOperationalLayers());
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.menu_layer_handle_tools_openAllLayer:
                                for (int i = 0; i< sceneView.getScene().getOperationalLayers().size(); i++){
                                    Layer layer = sceneView.getScene().getOperationalLayers().get(i);
            ...
            public void onClick(View v) {
                ...
                pmp.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.menu_layer_handle_tools_openAllLayer:
                                for (int i = 0; i< sceneView.getScene().getBasemap().getBaseLayers().size(); i++){
                                    Layer layer = sceneView.getScene().getBasemap().getBaseLayers().get(i);
                                    layer.setVisible(true);
                                }
        ...
        for (int i=0;i<fileInfos.size();i++) {
            ...
            shapefileFeatureTable.addDoneLoadingListener(new Runnable() {
                ...
                public void run() {
                    ...
                    sceneView.getScene().getOperationalLayers().add(mainShapefileLayer);
                }
            });
        }
    }
...
//                layer.setName(table.getName()+"-gpkg");
                         sceneView.getScene().getOperationalLayers().add(layer);
                     }
                 }
            });
...
//        resourceConfig.sceneView.addLayer(arcGISTiledMapServiceLayer);
        String configPath = getBasemapPath("basemap.json");
        BaseMapManager basemapManager = new BaseMapManager(context,super.sceneView,configPath);
        ...
        for (int i=0;i<basemapLayerInfoList.size();i++){
            ...
            if(type.equals(BasemapLayerInfo.LYAER_TYPE_TPK)){//TPK
                ...
                if(FileUtils.isExist(path)){//判断是否存在
                    ...
                    super.sceneView.getScene().getBasemap().getBaseLayers().add(localTiledLayer);
                }else{
                ...
                if(FileUtils.isExist(path)) {//判断是否存在
                    ...
                    super.sceneView.getScene().getBasemap().getBaseLayers().add(rasterLayer);
                }else{
                ...
                super.sceneView.getScene().getBasemap().getBaseLayers().add(tiledMapServiceLayer);
                ...
                super.sceneView.getScene().getBasemap().getBaseLayers().add(dynamicMapServiceLayer);
                ...
                if(FileUtils.isExist(path)) {//判断是否存在
                    ...
                    super.sceneView.getScene().getBasemap().getBaseLayers().add(arcGISVectorTiledLayer);
                }else{
