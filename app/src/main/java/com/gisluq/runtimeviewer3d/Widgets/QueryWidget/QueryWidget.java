package com.gisluq.runtimeviewer3d.Widgets.QueryWidget;
...
import com.gisluq.runtimeviewer3d.Widgets.QueryWidget.Adapter.LayerSpinnerAdapter;
import com.gisluq.runtimeviewer3d.Widgets.QueryWidget.Adapter.QueryResultAdapter;
...
public class QueryWidget extends BaseWidget {
    ...
    private TouchDelegate defauleOnTouchListener;//默认点击事件
//    private MapQueryOnTouchListener mapQueryOnTouchListener;//要素选择事件
    ...
    public void create() {
        ...
        defauleOnTouchListener = super.sceneView.getTouchDelegate();
...
//        mapQueryOnTouchListener = new MapQueryOnTouchListener(context, sceneView,txtLayerName,listViewField);
        ...
        LayerSpinnerAdapter layerSpinnerAdapter = new LayerSpinnerAdapter(context, sceneView.getScene().getOperationalLayers());
        ...
        featureQueryResult.addDoneListener(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    QueryResultAdapter queryResultAdapter = new QueryResultAdapter(context,mapQueryResult, sceneView);
...
////        sceneView.setMagnifierEnabled(true);//放大镜
//        if (mapQueryOnTouchListener!=null){
////            super.sceneView.setOnTouchListener(mapQueryOnTouchListener);
//        }
...
//        if (mapQueryOnTouchListener!=null){
//            super.sceneView.setTouchDelegate(defauleOnTouchListener);//窗口关闭恢复默认点击状态
//        }
//        mapQueryOnTouchListener.clear();//清空当前选择
//        sceneView.setMagnifierEnabled(false);//放大镜
    }
